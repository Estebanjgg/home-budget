...
export function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-800 mb-3">📊 Dashboard Financiero</h1>
        <p className="text-lg text-gray-600 mb-2">Resumen completo de tu situación financiera</p>
        <p className="text-gray-500">Analiza tus patrones de ingresos y gastos</p>
      </div>
